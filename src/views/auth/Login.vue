  ...
  <div>
    ...
    <div class="mt-6">
      ...
      <button 
        ...
        class="mt-4 w-full flex items-center justify-center gap-3 px-6 py-3 bg-white border-2 border-gray-200 rounded-xl font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all"
      >
    ...
    <p class="mt-6 text-center text-sm text-gray-500">
      ¿No tienes cuenta? 
      <router-link to="/auth/register" class="text-natillera-600 font-semibold hover:text-natillera-700">
        Regístrate aquí
      </router-link>
    </p>
  </div>
